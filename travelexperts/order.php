...
<head>
  ...
  <?php } else { ?>
    <script src="orderregcust.js"></script>
...
<body>
  ...
  <div class="container center">
    <?php if (!$isLogged) {?>
      ...
      <?php } else { ?>
        <form action="orderprocessregcust.php" id="userForm" method="post">
      <?php } ?>
...
<?php if (!$isLogged) {?>
      ...
      <div class="row">
        ...
        <div class="col-7">
          <input name="homePhone" type="number" id="inputHomePhone">
        </div>
      </div>
...
<?php } ?>
      ...
      <div class="row">
        ...
        <div class="col-7">
          <input name="travelerCount" type="number" min=1 id="inputTravelerCount">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-7">
          <input name="ccNumber" type="number" min=1 id="inputCCNumber">
        </div>
      </div>
